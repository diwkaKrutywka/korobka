    ...
    <div class="animate-fade-in flex flex-col items-center justify-center px-8 fhd:px-16 py-10 fhd:py-16 text-center max-w-lg fhd:max-w-3xl mx-auto">
      ...
      <div class="mt-5 fhd:mt-8 w-full">
        ...
        <div v-else-if="printStatus === 'error'"
          class="rounded-xl fhd:rounded-2xl overflow-hidden"
          style="background:#FEF2F2; border:1px solid #fecaca;">
          <div class="flex items-start gap-2 px-4 fhd:px-7 py-3 fhd:py-5 text-sm fhd:text-xl">
            <svg class="flex-shrink-0 mt-0.5" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
              <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
            </svg>
            <div class="text-left">
              <div class="font-bold" style="color:#dc2626">{{ t('booking.printErrorTitle') }}</div>
